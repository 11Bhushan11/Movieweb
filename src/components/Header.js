...
const Header = () => {
  ...
  return (
    <div className=' sticky z-10  header top-0 text-3xl flex justify-between items-center  text-red-500 font-bold p-3 border-b-2 border-white-500'>
    <Link to={'/'}><span >Filmy<span className='text-white '>Verse</span></span></Link>
    {/* agar login true hai to wo add kar paye  */}
    {useAppstate.login ?
