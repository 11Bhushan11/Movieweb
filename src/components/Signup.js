...
const Signup = () => {
  ...
  return (
    ...
    <h1 className='text-xl font-bold mt-20' >Sign up</h1>
    { otpSent ? 
    <>
      <div class="p-2 w-full md:w-1/3 mt-6 ">
          <div class="relative">
            <label for="message" class="leading-7 text-sm text-orange-200">OTP</label>
            <input
    ...
    <div class="p-2 w-full md:w-1/3 mt-6 ">
          <div class="relative">
            <label for="message" class="leading-7 text-sm text-orange-200">Name</label>
            <input
             id="message"
              name="message" 
    ...
    <div class="p-2 w-full md:w-1/3 mt-6 ">
          <div class="relative">
            <label for="message" class="leading-7 text-sm text-orange-200">Mobile No.</label>
            <input
            type={'number'} 
            id="message" 
            name="message"
        ...
        <div class="p-2 w-full md:w-1/3 mt-6 ">
          <div class="relative">
            <label for="message" class="leading-7 text-sm text-orange-200">Password </label>
            <input
             type={'password'}
             id="message"
              name="message" 
        ...
        <div class="p-2 w-full">
          ...
          {loading ? <TailSpin height={25} color='white' /> : 'Reqest OTP'}
